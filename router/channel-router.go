...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/link_implementations", permission: authz.ChannelRead, handler: controller.ListLinkImplementations},
	{method: http.MethodGet, path: "/link_model_publications", permission: authz.ChannelRead, handler: controller.ListLinkModelPublications},
	{method: http.MethodPost, path: "/link_model_publications/rebind", permission: authz.ChannelSensitiveWrite, handler: controller.RebindLinkModelPublication},
	...
	{method: http.MethodDelete, path: "/:id/asset_credential", permission: authz.ChannelSensitiveWrite, handler: controller.DeleteChannelAssetCredential},
