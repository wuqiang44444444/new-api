...
func SetApiRouter(router *gin.Engine) {
	...
	setBatchDashboardRouter(apiRouter)
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.DisableCache(), middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/contract", controller.GetSelfCustomerContract)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/contract", controller.GetCustomerContract)
				adminRoute.POST("/:id/contract", controller.PostCustomerContractEntity)
				adminRoute.GET("/:id/contract/options", controller.GetCustomerContractOptions)
				adminRoute.GET("/:id/contract/channels", controller.GetCustomerContractChannelOptions)
				adminRoute.GET("/:id/contract/audits", controller.GetCustomerContractAudits)
		...
		registerCustomerContractAdminRoutes(apiRouter)
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.POST("/customer_contract_ratio_impact", controller.PreviewCustomerContractRatioImpact)
			optionRoute.POST("/billing-expression/preview", controller.PreviewBillingExpression)
		...
		registerTaskContractRoutes(apiRouter)
		registerAuthzRoutes(apiRouter)
		registerUserBalanceRoutes(apiRouter)
		...
		systemInfoRoute.Use(middleware.RootAuth())
		{
			...
			systemInfoRoute.GET("/client-error-log", middleware.DisableCache(), controller.GetClientErrorLogHealth)
