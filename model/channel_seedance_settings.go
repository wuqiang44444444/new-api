...
func validateSeedanceChannelSettings(channel *Channel, settings *dto.ChannelOtherSettings) error {
	...
	case dto.AssetUpstreamProtocolRelayAssetsV1:
		if settings.VideoUpstreamProtocol != dto.VideoUpstreamProtocolMediaTaskV1 {
			return fmt.Errorf("Relay asset protocol requires the Media Task V1 video protocol")
		}
	}
