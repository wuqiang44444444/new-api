...
func InitDB() (err error) {
	...
	if err == nil {
		...
		if !common.IsMasterNode {
			return verifyLinkChannelMigrationState()
		}
		if common.UsingMainDatabase(common.DatabaseTypeMySQL) {
...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&QuotaData{},
		&Task{},
		&TaskPlugin{}, &TaskCreateIdempotency{}, &TaskCreateAttempt{}, &ProviderCostExposure{}, &Model{},
		&Vendor{},
		&PrefillGroup{},
		&Setup{},
		&TwoFA{},
	...
	if err := migrateSeedanceChannelTypeRenumber(); err != nil {
		return err
	}
