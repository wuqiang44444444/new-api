...
type Task struct {
	...
	TaskID                  string                `json:"task_id" gorm:"type:varchar(191)"`       // 第三方id，不一定有/ song id\ Task id
...
type TaskBillingContext struct {
	...
	InitialCalculation           *billingexpr.Calculation `json:"initial_calculation,omitempty"`
	SettlementCalculationVersion int                      `json:"settlement_calculation_version,omitempty"`
	SettlementCalculation        *billingexpr.Calculation `json:"settlement_calculation,omitempty"`
