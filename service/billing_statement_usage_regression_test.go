...
func TestStatementBatchKeepsInt64UsageAcrossSettlementAndDetail(t *testing.T) {
	...
	assert.EqualValues(t, 2600000000, provider.Groups[0].Usage.InputTokens)
	assert.EqualValues(t, 3000000000, provider.Groups[0].Usage.OutputTokens)
	assert.EqualValues(t, 2200000000, provider.Groups[0].Usage.CacheReadTokens)
}
