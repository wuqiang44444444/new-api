...
var (
	...
	ErrDefaultAssetGroupNotConfigured = errors.New("channel default asset group is not configured")
	ErrReservedAssetGroupName         = errors.New("asset group name is reserved")
)
