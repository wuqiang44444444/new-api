...
func BindVerificationOperation(operation VerificationOperation) (VerificationBinding, error) {
	...
	case VerificationScopeAccountUnbind:
		...
		normalized = context
	case VerificationScopeTaskUsageReview, VerificationScopeTaskAttemptRecover, VerificationScopeTaskAttemptReject,
		VerificationScopePasskeyRegister, VerificationScopePasskeyDelete, VerificationScopeTwoFASetup,
