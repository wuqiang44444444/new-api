...
func TestBatchContractTokenAuthPreservesMigrationGroupExemption(t *testing.T) {
	...
	token := model.Token{UserId: user.Id, Key: "batchauthregression", Status: common.TokenStatusEnabled, ExpiredTime: -1, RemainQuota: 1000, Group: "removed-native-group", ContractId: contract.Id}
