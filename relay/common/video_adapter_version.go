...
var videoAdapterRevisionRules = map[struct {
	...
	{ChannelType: constant.ChannelTypeSeedanceLink, Profile: dto.VideoUpstreamProfileThirdPartySynlinkVideoV1}:     {Current: VideoAdapterRevisionV1, Supported: []string{VideoAdapterRevisionV1}, AllowEmpty: false},
