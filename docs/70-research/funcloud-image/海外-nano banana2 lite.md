...
MD5: 7d3c47bf38198ebb9c07c5df25623fec
Copy Markdown
Copy HTML
Nano Banana 2 Lite Image Generation
Overview
Nano Banana 2 Lite Image Generationendpoint, Nano Banana 2, supported Text-to-Image (text-to-image) and Image-to-Image editing (image-to-image), Resolutionoutput,,, up to can provide 10 images reference images toImage-to-Image editing, supported Aspect ratio.
...
curl -X POST "https://api.apiverse.ai/api/v2/open/aigc/nano-banana-2-lite" \
...
1. create Nano Banana 2 Lite Image GenerationtaskPOST /api/v2/open/aigc/nano-banana-2-lite
   Create a Nano Banana 2 Lite Image Generationtask.
...
imageUrls string[] No Reference image URL (up to 10images, JPEG/PNG/WebP, each maximum 30MB)
aspectRatio string No Aspect ratio:auto(default) / 1:1 / 1:4 / 16:9 / 1:8 / 21:9 / 2:3 / 3:2 / 3:4 / 4:1 / 4:3 / 4:5 / 5:4 / 8:1 / 9:16
taskNickname string No task,
callbackUrl string No Callback notification URL after the task is complete
Description:

- Lite as Resolution output, supportedresolution / outputFormat Parameter
...
- supported up to 10 images Reference image, each maximum 30MB, supported JPEG/PNG/WebP Format#### Request Example
  Basic Text-to-Image:
...
3. Processing Time Reference
   Text-to-Image:Usually 5 ~ 15 seconds
   Image-to-Image editing:Usually 5 ~ 20 seconds
4. localized example text| localized example text| Scenario| |--------|---------| | Nano Banana 2 Lite |,, etc. and Scenario| | Nano Banana 2 | Resolution (1K/2K/4K) output, height Scenario|
