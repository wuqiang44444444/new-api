...
素材状态为 `Active` 后，可在视频请求中引用。V2 媒体任务（包括当前
`doubao-seedance-2-0-260128`）使用 `image` / `reference_images` 等字段。历史
`dreamina-seedance-2-0-260128` Ark 素材合同不属于当前 doubao 渠道，不能混配。
