...
> **历史资料。** 本文只描述 `dreamina-seedance-2-0-260128` 的旧 Ark 素材线路，不适用于当前
> `doubao-seedance-2-0-260128` TokenSave V2 relay 渠道。当前 doubao 渠道使用
> `third_party_relay + relay_assets`，不得配置为 `ark_assets`。
