...
> **历史资料，不是当前 `doubao-seedance-2-0-260128` 的接入依据。** 本文记录的是
> `dreamina-seedance-2-0-260128` 与 `/v1/ark/*` 的历史 Moxing Ark 线路。当前 doubao 模型使用
> TokenSave V2 `/v1/media/*` 合同，见 [TokenSave doubao Seedance 2.0](TokenSave%20doubao%20Seedance%202.0.md)。
