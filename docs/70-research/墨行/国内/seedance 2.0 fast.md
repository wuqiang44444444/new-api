...
| `model` | string | 是 | 模型 ID；固定使用 `doubao-seedance-2-0-fast-260128`。示例：`doubao-seedance-2-0-fast-260128` |
| `ratio` | string | 否 | 画幅比例；常见支持 `16:9` / `4:3` / `1:1` / `3:4` / `9:16` / `21:9` / `adaptive`。示例：`16:9` |
| `resolution` | string | 否 | 分辨率；建议使用 `720p`；fast 版本常用展示为 `480p` / `720p`。示例：`720p` |
