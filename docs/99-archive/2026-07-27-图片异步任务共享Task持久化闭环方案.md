...
superseded-by: "../20-architecture/统一图片生成与异步任务架构.md; ../20-architecture/decisions/0006-media-image-shared-task-persistence.md"
---

# 图片异步任务共享 Task 持久化闭环方案

> 本文保留实施设计与验收记录。当前长期架构以[统一图片生成与异步任务架构](../20-architecture/统一图片生成与异步任务架构.md)和 [ADR-0006](../20-architecture/decisions/0006-media-image-shared-task-persistence.md) 为准。
