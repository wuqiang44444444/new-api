...
superseded-by: "../20-architecture/Link合同架构.md; ../20-architecture/视频上游接入与异步任务架构.md; ../20-architecture/素材代理与真人授权架构.md"
---

# 视频官方北向与统一素材库合同重构方案

> 本文保留重构步骤与完成清单。当前总合同以[Link 合同架构](../20-architecture/Link合同架构.md)为准，专题细节见[视频上游接入与异步任务架构](../20-architecture/视频上游接入与异步任务架构.md)和[素材代理与真人授权架构](../20-architecture/素材代理与真人授权架构.md)。
