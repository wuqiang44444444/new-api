...
export type BillingStatementDataQuality = {
  saturated?: boolean
}
...
export type BillingSummary = {
  ...
  stream_ratio: number
  data_quality?: BillingStatementDataQuality
}
...
export type BillingCacheBreakdown = {
  ...
  denominator_requests: number
  denominator_scope: 'all_settled_requests'
  read_tokens: number
  write_tokens: number
  write_tokens_5m: number
  write_tokens_1h: number
...
export type BillingBreakdownDataQuality = {
