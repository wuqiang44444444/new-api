...
import type { CustomerContractsSearch } from './types'
...
export function CustomerContracts(props: CustomerContractsProps) {
...
export type { CustomerContractsSearch } from './types'
