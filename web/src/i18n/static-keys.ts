...
export const STATIC_I18N_KEYS = [
  ...
  'Cannot estimate: historical group ratio not recorded',
  'Estimate failed: invalid billing records',
  'Cannot estimate: surcharge breakdown missing',
  'Estimate failed: amount out of range',
  'Cannot estimate: combined row details unavailable',
  'Cannot estimate: reason not recorded in this historical statement',
  'Unknown: historical contract status not recorded',
  'Unknown: historical group ratio not recorded',
  'Unknown: invalid billing records',
  'Not applicable to a combined row',
  'No discount (×1)',
