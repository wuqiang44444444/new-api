...
type MoxingVideoModelContract = kitdto.MoxingVideoModelContract

var (
	MoxingVideoModelContracts   = kitdto.MoxingVideoModelContracts
	MoxingVideoModelContractFor = kitdto.MoxingVideoModelContractFor
)
