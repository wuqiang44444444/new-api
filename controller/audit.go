...
var auditContentTemplates = map[string]string{
	...
	"task_contract.attempt_recover":  "Recovered task create attempt ${attempt_id} as ${public_task_id}",
	"task_contract.exposure_resolve": "Resolved provider exposure incident ${incident_id}",
